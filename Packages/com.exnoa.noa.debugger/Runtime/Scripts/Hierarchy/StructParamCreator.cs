...
{
    sealed class StructParamCreator : IParamCreator
    {
        public List<GameObjectDetailEntry> CreateSubParameter(Object obj, Component component, int depth)
        {
            ...
            FieldInfo[] fieldInfos = obj.GetType().GetFields(BindingFlags.Public | BindingFlags.Instance | BindingFlags.NonPublic);
